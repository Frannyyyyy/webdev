...
<head>
    ...
    <title>Help Center - ServeIt</title>
    ...
    <style>
        ...
        .help-card:hover { transform: translate(-4px, -4px); box-shadow: 12px 12px 0px 0px rgba(0,0,0,1); }
        ...
        body.dark-mode .bg-[#D9D6D2] { background-color: #444 !important; color: #e0e0e0; }
        body.dark-mode .lofi-border { border-color: #e0e0e0; }
        body.dark-mode .lofi-shadow { box-shadow: 8px 8px 0px 0px #e0e0e0; }
        body.dark-mode .help-card:hover { box-shadow: 12px 12px 0px 0px #e0e0e0; }
...
<body class="bg-[#FBF7EB] min-h-screen flex font-sans text-black overflow-hidden">
...
<main class="flex-1 p-12 overflow-y-auto">
    <header class="flex justify-between items-start mb-16">
        <div>
            <h1 class="text-7xl font-black uppercase italic tracking-tighter mb-4">Help Center</h1>
            <p class="text-sm font-bold uppercase leading-relaxed max-w-2xl opacity-80">
                Need assistance with your document requests? Browse our guides or contact support directly through the channels provided.
            </p>
        </div>
        <div class="flex flex-col items-end gap-6">
            ...
            <div class="flex items-center gap-3">
                <span class="font-black text-2xl italic uppercase">Serve It</span>
    ...
    <div class="grid grid-cols-2 gap-10">
        <button class="help-card bg-[#D9D6D2] lofi-border lofi-shadow p-10 rounded-3xl text-left transition-all group relative overflow-hidden">
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-4xl font-black uppercase italic mb-4 group-hover:text-[#1747E7]">FAQs</h3>
                    <p class="font-bold uppercase text-xs leading-relaxed opacity-70">Frequently Asked Questions</p>
                </div>
                <img src="{{ asset('images/h.faq.png') }}" class="w-24 h-24 object-contain">
            </div>
        </button>
        ...
        <button class="help-card bg-[#D9D6D2] lofi-border lofi-shadow p-10 rounded-3xl text-left transition-all group relative overflow-hidden">
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-4xl font-black uppercase italic mb-4 group-hover:text-[#1747E7]">Get Started</h3>
                    <p class="font-bold uppercase text-xs leading-relaxed opacity-70">New to ServeIt? Learn the basics here.</p>
                </div>
                <img src="{{ asset('images/h.getstarted.png') }}" class="w-24 h-24 object-contain">
            </div>
        </button>
        ...
        <button class="help-card bg-[#D9D6D2] lofi-border lofi-shadow p-10 rounded-3xl text-left transition-all group relative overflow-hidden">
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-4xl font-black uppercase italic mb-4 group-hover:text-[#1747E7]">Privacy & Security</h3>
                    <p class="font-bold uppercase text-xs leading-relaxed opacity-70">Your data, protected. Your trust, earned. We guard your information 
                        with robust security and respect your privacy by design.</p>
                </div>
                <img src="{{ asset('images/h.howto.png') }}" class="w-24 h-24 object-contain">
            </div>
        </button>
        ...
        <button class="help-card bg-[#D9D6D2] lofi-border lofi-shadow p-10 rounded-3xl text-left transition-all group relative overflow-hidden">
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-4xl font-black uppercase italic mb-4 group-hover:text-[#1747E7]">Contact Us</h3>
                    <p class="font-bold uppercase text-xs leading-relaxed opacity-70">Reach out for personalized guidance.</p>
                </div>
                <img src="{{ asset('images/h.contactus.png') }}" class="w-24 h-24 object-contain">
            </div>
        </button>
    </div>
</main>
